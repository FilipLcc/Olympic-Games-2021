...
const nation_1 = __importDefault(require("./model/nation"));
...
const format_1 = __importDefault(require("./model/format"));
...
mongoose_1.default.connect("mongodb://localhost:27017/Olimpijada_2021");
...
router.route("/login").post((req, res) => {
    ...
    user_1.default.findOne({ "username": username, "password": password }, (err, foundUser) => {
        if (err)
            console.log(err);
        else {
            if (foundUser) {
...
router.route("/allNations").post((req, res) => {
    nation_1.default.find({}, (err, foundNations) => {
        if (err)
            console.log(err);
        else {
...
router.route("/allSports").post((req, res) => {
    sport_1.default.find({}, (err, foundSports) => {
        if (err)
            console.log(err);
        else {
...
router.route("/allDisciplines").post((req, res) => {
    discipline_1.default.find({}, (err, foundDiscs) => {
        if (err)
            console.log(err);
        else {
            res.json(foundDiscs);
...
router.route("/allVenues").post((req, res) => {
    venue_1.default.find({}, (err, foundVenues) => {
        if (err)
            console.log(err);
        else {
...
router.route("/allFormats").post((req, res) => {
    format_1.default.find({}, (err, foundFormats) => {
        if (err)
            console.log(err);
        else
...
router.route("/comparePasswords").post((req, res) => {
    ...
    let username = req.body.username;
    user_1.default.findOne({ "username": username }, (err, foundUser) => {
        if (err)
            console.log(err);
        else {
            if (!foundUser) {
                ...
                //all good
                user_1.default.collection.updateOne({ "username": username }, { $set: { "password": entered_new_pass } });
                res.json({ "message": "ok" });
            }
        }
    });
...
router.route("/checkRegistrationData").post((req, res) => {
    ...
    if (!entered_username.match(let_num_und_dash) || !entered_name.match(personal) || !entered_surname.match(personal) ||
        ...
        nation_1.default.findOne({ "name": chosen_nation }, (err, foundNation) => {
            if (err)
                console.log(err);
            else {
                if (foundNation) {
...
router.route("/addASport").post((req, res) => {
    ...
    sport_1.default.findOne(search_object, (err, foundSport) => {
        if (err)
            console.log(err);
        else {
            if (foundSport) {
                ...
                venue_1.default.find({ "sports.name": req.body.name }, (err2, foundVenue) => {
                    if (err2)
                        console.log(err2);
                    else {
                        if (foundVenue.length > 0) {
                            sport_1.default.collection.insertOne(search_object);
...
router.route("/addADiscipline").post((req, res) => {
    discipline_1.default.findOne({ "name": req.body.name }, (err, foundDisc) => {
        if (err)
            console.log(err);
        else {
            if (foundDisc) {
                ...
                discipline_1.default.collection.insertOne(obj);
...
router.route("/addACompetition").post((req, res) => {
    ...
    competition_1.default.findOne({ "discipline": req.body.discipline, "gender": req.body.gender }, (err, foundComp) => {
        if (err)
            console.log(err);
        else {
            if (foundComp) {
                ...
                competition_1.default.collection.insertOne(obj);
...
router.route("/allCompetitions").post((req, res) => {
    competition_1.default.find({}, (err, foundComps) => {
        if (err)
            console.log(err);
        else {
            res.json(foundComps);
...
router.route("/competitionsNoDelegates").post((req, res) => {
    competition_1.default.find({ "delegate": "" }, (err, foundComps) => {
        if (err)
            console.log(err);
        else
            res.json(foundComps);
...
router.route("/getDelegates").post((req, res) => {
    user_1.default.find({ "role": "delegate" }, (err, foundUsers) => {
        if (err)
            console.log(err);
        else
            res.json(foundUsers);
...
router.route("/getOurAthletes").post((req, res) => {
    athlete_1.default.find({ "nation": req.body.nation }, (err, foundAthletes) => {
        if (err)
            console.log(err);
        else {
...
router.route("/getNationByName").post((req, res) => {
    nation_1.default.findOne({ "name": req.body.nation }, (err, foundNation) => {
        if (err)
            console.log(err);
        else
...
router.route("/getFormatByName").post((req, res) => {
    format_1.default.findOne({ "format_name": req.body.format }, (err, foundFormat) => {
        if (err)
            console.log(err);
        else {
...
router.route("/getEligibleAthletes").post((req, res) => {
    athlete_1.default.find({ "gender": req.body.gender, "disciplines.discipline_name": req.body.discipline }, (err, foundAthletes) => {
        if (err)
            console.log(err);
        else {
            res.json(foundAthletes);
...
router.route("/checkAvailability").post((req, res) => {
    venue_1.default.findOne({ "name": req.body.venue, "busy_dates.start_date": req.body.start_date }, (err, foundVenue) => {
        if (err)
            console.log(err);
        else {
            if (foundVenue) {
...
router.route("/ensureMutex").post((req, res) => {
    venue_1.default.find({ "sports.name": req.body.sport, "busy_dates.start_date": req.body.start_date, "busy_dates.gender": req.body.gender }, (err, foundBusy) => {
        if (err)
            console.log(err);
        else {
...
router.route("/connectWithComp").post((req, res) => {
    schedule_1.default.findOne({ "id_competition": req.body.id_comp }, (err, foundSchedule) => {
        if (err)
            console.log(err);
        else {
            if (foundSchedule) {
...
router.route("/checkFormedCompetition").post((req, res) => {
    competition_1.default.findById(req.body.id_comp, (err, foundComp) => {
        if (err)
            console.log(err);
        else {
            if (foundComp) {
...
router.route("/formACompetition").post((req, res) => {
    ...
    competition_1.default.collection.updateOne({ "_id": ObjectId(req.body.id_comp) }, { $set: { "formed": true } }, (err, success) => {
        if (err)
            console.log(err);
        else {
            res.json({ "message": "ok" });
...
router.route("/endCompetition").post((req, res) => {
    // { $set: { "mySchedule.results": schedule_obj.mySchedule.results } }
    competition_1.default.collection.updateOne({ "_id": ObjectId(req.body.id_comp) }, { $set: { "over": true } }, (err, success) => {
        if (err)
            console.log(err);
        else {
...
router.route("/findSchedule").post((req, res) => {
    schedule_1.default.findOne({ "id_competition": req.body.id_comp }, (err, foundComp) => {
        if (err)
            console.log(err);
        else
            res.json(foundComp);
...
router.route("/getAthleteById").post((req, res) => {
    athlete_1.default.findById(req.body.athlete, (err, foundAthlete) => {
        if (err)
            console.log(err);
        else
    ...
    if (format_obj.fixture == "one_game") {
        if (format_obj.result_format == "MM:SS,TT") {
            ...
            if (!schedule_obj.mySchedule.redo) {
                ...
                let values_existing_as_duplicates = new Array();
                let preliminary_matrix_of_duplicates = new Array(); //CHANGED OBJECT TO ANY
                for (let i = 0; i < numeric_value_array.length; i++) {
                    ...
                    preliminary_matrix_of_duplicates.push(new Array());
                    let first_time = true;
                ...
                let final_matrix_of_duplicates = new Array();
                ...
                athlete_1.default.find({}, (errAth, foundAthletes) => {
                    if (errAth) {
                        console.log(errAth);
                    }
                    else {
                        if (foundAthletes.length == 0) {
                            ...
                            if (final_matrix_of_duplicates.length > 0) {
                                ...
                                schedule_1.default.collection.updateOne({ "_id": ObjectId(schedule_obj._id) }, {
                                    $set: {
                                ...
                                athlete_1.default.collection.updateOne({ "_id": ObjectId(gold_res.id_player) }, { $set: { "medals": true } });
                                athlete_1.default.collection.updateOne({ "_id": ObjectId(silver_res.id_player) }, { $set: { "medals": true } });
                                athlete_1.default.collection.updateOne({ "_id": ObjectId(bronze_res.id_player) }, { $set: { "medals": true } });
                                //find the competition in order to see which discipline should be updated
                                competition_1.default.findById(schedule_obj.id_competition, (errComp, foundCompetition) => {
                                    if (errComp)
                                        console.log(errComp);
                                    else {
                                        if (!foundCompetition) {
                                            ...
                                            for (let i = 0; i < schedule_obj.mySchedule.results.length; i++) {
                                                if (schedule_obj.mySchedule.results[0][i].id_player == gold_res.id_player) {
                                                    athlete_1.default.collection.updateOne({ "_id": ObjectId(gold_res.id_player), "disciplines.discipline_name": foundCompetition.toObject().discipline }, {
                                                        '$set': {
                                                    ...
                                                    athlete_1.default.collection.updateOne({ "_id": ObjectId(silver_res.id_player), "disciplines.discipline_name": foundCompetition.toObject().discipline }, {
                                                        '$set': {
                                                    ...
                                                    athlete_1.default.collection.updateOne({ "_id": ObjectId(bronze_res.id_player), "disciplines.discipline_name": foundCompetition.toObject().discipline }, {
                                                        '$set': {
                                                    ...
                                                    athlete_1.default.collection.updateOne({ "_id": ObjectId(schedule_obj.mySchedule.results[0][i].id_player), "disciplines.discipline_name": foundCompetition.toObject().discipline }, {
                                                        '$set': {
                                ...
                                //
                                athlete_1.default.findById(ObjectId(gold_res.id_player), (err, foundGold) => {
                                    if (err)
                                        console.log(err);
                                    else {
                                        if (foundGold) {
                                            let gold_obj = foundGold.toObject();
                                            nation_1.default.collection.updateOne({ "name": gold_obj.nation }, { $inc: { "gold_cnt": 1 } });
                                            nation_1.default.collection.updateOne({ "name": gold_obj.nation }, { $inc: { "overall": 1 } });
                                        }
                                    }
                                });
                                athlete_1.default.findById(ObjectId(silver_res.id_player), (err, foundSilver) => {
                                    if (err)
                                        console.log(err);
                                    else {
                                        if (foundSilver) {
                                            let silver_obj = foundSilver.toObject();
                                            nation_1.default.collection.updateOne({ "name": silver_obj.nation }, { $inc: { "silver_cnt": 1 } });
                                            nation_1.default.collection.updateOne({ "name": silver_obj.nation }, { $inc: { "overall": 1 } });
                                        }
                                    }
                                });
                                athlete_1.default.findById(ObjectId(bronze_res.id_player), (err, foundBronze) => {
                                    if (err)
                                        console.log(err);
                                    else {
                                        if (foundBronze) {
                                            let bronze_obj = foundBronze.toObject();
                                            nation_1.default.collection.updateOne({ "name": bronze_obj.nation }, { $inc: { "bronze_cnt": 1 } });
                                            nation_1.default.collection.updateOne({ "name": bronze_obj.nation }, { $inc: { "overall": 1 } });
                                        }
                                    }
                                });
        ...
        for (let i = 0; i < schedule_obj.mySchedule.left_bracket.length; i++) {
            if (schedule_obj.mySchedule.left_bracket[i].done == false) {
                ...
                match_date.setHours(hrs_and_minutes[0]);
                match_date.setMinutes(hrs_and_minutes[1]);
                venue_1.default.collection.updateOne({ "name": schedule_obj.mySchedule.left_bracket[i].venue }, { $push: { "busy_dates": { start_date: match_date.toISOString(), gender: req.body.gender } } });
            }
        }
        for (let i = 0; i < schedule_obj.mySchedule.right_bracket.length; i++) {
            if (schedule_obj.mySchedule.right_bracket[i].done == false) {
                ...
                match_date.setHours(hrs_and_minutes[0]);
                match_date.setMinutes(hrs_and_minutes[1]);
                venue_1.default.collection.updateOne({ "name": schedule_obj.mySchedule.right_bracket[i].venue }, { $push: { "busy_dates": { start_date: match_date.toISOString(), gender: req.body.gender } } });
            }
        }
        ...
        if (schedule_obj.mySchedule.left_bracket[schedule_obj.mySchedule.left_bracket.length - 1].round == 2) {
            ...
            if (schedule_obj.mySchedule.left_bracket[schedule_obj.mySchedule.left_bracket.length - 1].done) {
                ...
                let gold_res, silver_res, bronze_res;
                ...
                athlete_1.default.collection.updateOne({ "_id": ObjectId(gold_res) }, { $set: { "medals": true } });
                athlete_1.default.collection.updateOne({ "_id": ObjectId(silver_res) }, { $set: { "medals": true } });
                athlete_1.default.collection.updateOne({ "_id": ObjectId(bronze_res) }, { $set: { "medals": true } });
                        ...
                        if (!foundCompetition) {
                            ...
                            for (let i = 0; i < limit; i++) {
                                ...
                                if (schedule_obj.mySchedule.left_bracket[i].id_p1 == gold_res) {
                                    athlete_1.default.collection.updateOne({ "_id": ObjectId(gold_res), "disciplines.discipline_name": foundCompetition.toObject().discipline }, {
                                        '$set': {
                                            'disciplines.$.medal': 'gold'
                                        }
                                    });
                                    ...
                                    athlete_1.default.collection.updateOne({ "_id": ObjectId(silver_res), "disciplines.discipline_name": foundCompetition.toObject().discipline }, {
                                        '$set': {
                                            'disciplines.$.medal': 'silver'
                                        }
                                    });
                                    ...
                                    athlete_1.default.collection.updateOne({ "_id": ObjectId(bronze_res), "disciplines.discipline_name": foundCompetition.toObject().discipline }, {
                                        '$set': {
                                            'disciplines.$.medal': 'bronze'
                                        }
                                    });
                                    ...
                                    athlete_1.default.collection.updateOne({ "_id": ObjectId(schedule_obj.mySchedule.left_bracket[i].id_p1), "disciplines.discipline_name": foundCompetition.toObject().discipline }, {
                                        '$set': {
                                            'disciplines.$.medal': 'none'
                                        }
                                    });
                                ...
                                if (schedule_obj.mySchedule.left_bracket[i].id_p2 == gold_res) {
                                    ...
                                    athlete_1.default.collection.updateOne({ "_id": ObjectId(schedule_obj.mySchedule.left_bracket[i].id_p2), "disciplines.discipline_name": foundCompetition.toObject().discipline }, {
                                        '$set': {
                                            'disciplines.$.medal': 'none'
                                        }
                                    });
                                ...
                                if (schedule_obj.mySchedule.right_bracket[i].id_p1 == gold_res) {
                                    ...
                                    athlete_1.default.collection.updateOne({ "_id": ObjectId(schedule_obj.mySchedule.right_bracket[i].id_p1), "disciplines.discipline_name": foundCompetition.toObject().discipline }, {
                                        '$set': {
                                            'disciplines.$.medal': 'none'
                                        }
                                    });
                                ...
                                if (schedule_obj.mySchedule.right_bracket[i].id_p2 == gold_res) {
                                    ...
                                    athlete_1.default.collection.updateOne({ "_id": ObjectId(schedule_obj.mySchedule.right_bracket[i].id_p2), "disciplines.discipline_name": foundCompetition.toObject().discipline }, {
                                        '$set': {
                                            'disciplines.$.medal': 'none'
                                        }
                                    });
                ...
                athlete_1.default.findById(ObjectId(gold_res), (err, foundGold) => {
                    if (err)
                        console.log(err);
                    else {
                        if (foundGold) {
                ...
                athlete_1.default.findById(ObjectId(silver_res), (err, foundSilver) => {
                    if (err)
                        console.log(err);
                    else {
                        if (foundSilver) {
                ...
                athlete_1.default.findById(ObjectId(bronze_res), (err, foundBronze) => {
                    if (err)
                        console.log(err);
                    else {
                        if (foundBronze) {
...
router.route("/addMoreAthletes").post((req, res) => {
    ...
    if (format == "one_game") {
        ...
        competition_1.default.findById(comp_id, (err, found) => {
            if (err)
                console.log(err);
            else {
                if (found) {
                    ...
                    for (let i = 0; i < to_add.length; i++) {
                        competition_1.default.collection.updateOne({ "_id": ObjectId(comp_id) }, { $push: { "participants": { id_player: to_add[i].id_player } } });
                    }
                    schedule_1.default.findOne({ "id_competition": comp_id }, (err2, foundSchedule) => {
                        if (err2) {
                            console.log(err2);
                        }
                        else {
                            if (foundSchedule) {
                                ...
                                //     }
                                // }
                                schedule_1.default.collection.updateOne({ "id_competition": comp_id }, { $set: { "mySchedule.results": schedule_obj.mySchedule.results } });
...
router.route("/InsertSchedule").post((req, res) => {
    schedule_1.default.collection.insertOne(req.body);
    //venue.collection.updateOne({"name":req.body.venue}, { $push: { "busy_dates": {start_date:req.body.start_date, gender:req.body.gender} } });
    for (let i = 0; i < req.body.mySchedule.results[0].length; i++) {
        competition_1.default.collection.updateOne({ "_id": ObjectId(req.body.id_competition) }, { $push: { "participants": { id_player: req.body.mySchedule.results[0][i].id_player } } });
    }
    res.json({ "message": "Ok" });
});
router.route("/InsertKnockoutSchedule").post((req, res) => {
    schedule_1.default.collection.insertOne(req.body.schedule);
    for (let i = 0; i < req.body.schedule.mySchedule.left_bracket.length; i++) {
        competition_1.default.collection.updateOne({ "_id": ObjectId(req.body.schedule.id_competition) }, { $push: { "participants": { id_player: req.body.schedule.mySchedule.left_bracket[i].id_p1 } } });
        competition_1.default.collection.updateOne({ "_id": ObjectId(req.body.schedule.id_competition) }, { $push: { "participants": { id_player: req.body.schedule.mySchedule.left_bracket[i].id_p2 } } });
        ...
        match_date.setHours(hrs_and_minutes[0]);
        match_date.setMinutes(hrs_and_minutes[1]);
        venue_1.default.collection.updateOne({ "name": req.body.schedule.mySchedule.left_bracket[i].venue }, { $push: { "busy_dates": { start_date: match_date.toISOString(), gender: req.body.gender } } });
    }
    for (let i = 0; i < req.body.schedule.mySchedule.right_bracket.length; i++) {
        competition_1.default.collection.updateOne({ "_id": ObjectId(req.body.schedule.id_competition) }, { $push: { "participants": { id_player: req.body.schedule.mySchedule.right_bracket[i].id_p1 } } });
        competition_1.default.collection.updateOne({ "_id": ObjectId(req.body.schedule.id_competition) }, { $push: { "participants": { id_player: req.body.schedule.mySchedule.right_bracket[i].id_p2 } } });
        ...
        match_date.setHours(hrs_and_minutes[0]);
        match_date.setMinutes(hrs_and_minutes[1]);
        venue_1.default.collection.updateOne({ "name": req.body.schedule.mySchedule.right_bracket[i].venue }, { $push: { "busy_dates": { start_date: match_date.toISOString(), gender: req.body.gender } } });
    }
    res.json({ "message": "Ok" });
});
router.route("/setBusyVenue").post((req, res) => {
    venue_1.default.collection.updateOne({ "name": req.body.venue }, { $push: { "busy_dates": { start_date: req.body.start_date, gender: req.body.gender } } });
    res.json({ "message": "You have successfully created a schedule." });
});
router.route("/assignDelegate").post((req, res) => {
    competition_1.default.find({ "delegate": req.body.username }, (err, foundComp) => {
        if (err)
            console.log(err);
        else {
            if (!foundComp) {
                ...
                if (foundComp.length >= 3) {
                    ...
                    //has no delegate
                    competition_1.default.findOne({ "discipline": req.body.discipline, "gender": req.body.gender }, (err2, foundTheComp) => {
                        if (err2)
                            console.log(err2);
                        else {
                            if (!foundTheComp) {
                                ...
                                if (compObj.delegate != "") {
                                    ...
                                    competition_1.default.collection.updateOne({ "discipline": req.body.discipline, "gender": req.body.gender }, { $set: { "delegate": req.body.username } }, () => {
...
router.route("/addAFormat").post((req, res) => {
    format_1.default.findOne({ "format_name": req.body.format_name }, (err, foundFormat) => {
        if (err)
            console.log(err);
        else {
            if (foundFormat) {
                ...
                format_1.default.collection.insertOne(obj);
    ...
    sport_1.default.find({}, (err, foundSports) => {
        if (err) {
            ...
            if (foundSports.length == 0) {
                ...
                athlete_1.default.find({}, (err2, foundAthletes) => {
                    if (err2)
                        console.log(err2);
                    else {
                        if (foundAthletes.length != 0) {
                        ...
                        competition_1.default.find({ "gender": "male", "formed": true }, (err3, foundComps) => {
                            if (err3)
                                console.log(err3);
                            else {
                                ...
                                competition_1.default.find({ "gender": "female", "formed": true }, (err4, foundFComps) => {
                                    if (err4)
                                        console.log(err4);
                                    else {
                                        ...
                                        //everything ok
                                        for (let i = 0; i < json_obj.myAthletes.length; i++) {
                                            athlete_1.default.collection.insertOne(json_obj.myAthletes[i]);
                                            nation_1.default.collection.updateOne({ "name": json_obj.myAthletes[i].nation }, { $inc: { "athlete_cnt": 1 } });
                                        }
...
router.route("/submitAnAthlete").post((req, res) => {
    athlete_1.default.findOne({
        "name": req.body.name, "surname": req.body.surname, "nation": req.body.nation, "sport": req.body.sport
    }, (err, foundAthlete) => {
        if (err)
            console.log(err);
        else {
            if (foundAthlete) {
                ...
                competition_1.default.find({ "gender": req.body.gender, "formed": true }, (err1, foundComps) => {
                    if (err1)
                        console.log(err1);
                    else {
                        if (!foundComps) {
                            ...
                            if (req.body.sport == "Tennis") {
                                athlete_1.default.findOne({ "carrier": req.body.carrier }, (errCarr, foundCarrier) => {
                                    if (errCarr) {
                                        console.log(errCarr);
                                    }
                                    else {
                                        if (foundCarrier) {
                                            ...
                                            athlete_1.default.collection.insertOne(obj);
                                            nation_1.default.collection.updateOne({ "name": obj.nation }, { $inc: { "athlete_cnt": 1 } });
...
router.route("/isCompetitionFormed").post((req, res) => {
    competition_1.default.findOne({ "discipline": req.body.discipline, "gender": req.body.gender, "formed": true }, (err, foundComp) => {
        if (err) {
            console.log(err);
...
router.route("/delegatesCompetition").post((req, res) => {
    competition_1.default.find({ "delegate": req.body.username }, (err, foundComps) => {
        if (err)
            console.log(err);
        else {
            res.json(foundComps);
...
router.route("/getAthletes").post((req, res) => {
    ...
    athlete_1.default.find(search_object, (err, foundAthletes) => {
        if (err)
            console.log(err);
        else {
            res.json(foundAthletes);
...
router.route("/register").post((req, res) => {
    user_1.default.findOne({ "username": req.body.username }, (err, foundUser) => {
        if (err) {
            ...
            request_1.default.findOne({ "username": req.body.username, "accepted": "pending" }, (err1, foundRequest) => {
                if (err1) {
                    console.log(err1);
                    res.json({ "message": "There was a problem with a server, please try again later." });
                    return;
                    ...
                    if (foundRequest) {
                        ...
                        if (req.body.role == "leader") {
                            user_1.default.findOne({ "nation": req.body.nation, "role": "leader" }, (err2, foundLeader) => {
                                if (err2) {
                                    console.log(err2);
                                    res.json({ "message": "There was a problem with a server, please try again later." });
                                    return;
                                    ...
                                    if (foundLeader) {
                                        ...
                                        request_1.default.collection.insertOne(req.body);
                                        res.json({
...
router.route("/pendingRequests").post((req, res) => {
    request_1.default.find({ "accepted": "pending" }, (err, foundRequests) => {
        if (err) {
            console.log(err);
        }
        else {
...
router.route("/confirmRequest").post((req, res) => {
    let user_object = {
        ...
        role: req.body.role,
        delegated_competitions: new Array()
    };
    user_1.default.findOne({ "username": req.body.username }, (error, foundUser) => {
        if (error) {
            console.log(error);
        }
        else {
                    ...
                    user_1.default.findOne({ "nation": req.body.nation, "role": "leader" }, (err2, foundLeader) => {
                        if (err2)
                            ...
                            if (foundLeader) {
                                ...
                                user_1.default.collection.insertOne(user_object, (err, returned) => {
                                    if (err) {
                                        console.log(err);
                                    }
                                    else {
                                        request_1.default.collection.updateOne({ "username": req.body.username }, { $set: { "accepted": "accepted" } }, () => {
...
router.route("/denyRequest").post((req, res) => {
    request_1.default.collection.updateOne({ "username": req.body.username, "accepted": "pending" }, { $set: { "accepted": "denied" } }, (err, updatedRequest) => {
        if (err)
            console.log(err);
        else {
            if (updatedRequest) {
